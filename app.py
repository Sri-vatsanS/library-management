...
if menu == "Add Book":
    ...
    with st.form("add_book_form"):
        ...
        genre = st.selectbox("Genre", ["Fiction", "Non-Fiction", "Romantic", "Science"])
        year = st.number_input("Year of Publication", min_value=1000, max_value=2023, step=1, value=2023)
        ...
        if submit:
            if title and author:
                ...
                st.error("Please fill in both Title and Author fields.")
